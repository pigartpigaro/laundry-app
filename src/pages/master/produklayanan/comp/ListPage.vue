                ...
                >
                  ...
                  <q-item-section class="row">
                    <q-item-label lines="1"
                      >{{ item?.produk }}
                      <q-badge color="grey-8" style="height: 20px">{{
...
import { formatRp, formattanpaRp } from "src/modules/formatter";
import { humanDate, jamTnpDetik } from "src/modules/utils";
import { useMasterProdukStore } from "src/stores/master/produklayanan/list";
import { computed, onBeforeMount, ref } from "vue";

const store = useMasterProdukStore();
