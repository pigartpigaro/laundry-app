                ...
                >
                  ...
                  <q-item-section>
                    <q-item-label lines="1"
                      >{{ item?.pelanggan }}
                      <q-badge color="pink-8" style="height: 20px">{{
                        formatPhone(item?.nohp)
                      }}</q-badge>
                    </q-item-label>
...
import { formatPhone } from "src/modules/formatter";
import { humanDate, jamTnpDetik } from "src/modules/utils";
import { useMasterPelangganStore } from "src/stores/master/pelanggan/list";
import { computed, onBeforeMount, ref } from "vue";

const store = useMasterPelangganStore();
